...
class SearchEve extends StatefulWidget {
  const SearchEve({Key? key}) : super(key: key);

  @override
  _SearchEveState createState() => _SearchEveState();
}

class _SearchEveState extends State<SearchEve> {
  @override
